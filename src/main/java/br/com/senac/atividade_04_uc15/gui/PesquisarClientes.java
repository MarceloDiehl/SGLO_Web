...
public class PesquisarClientes extends javax.swing.JFrame {
    ...
    public PesquisarClientes() {
        ...
        preencherTabela(cadastroClienteDAO.listar(txtCPF.getText()));
    }
        ...
        if (linha != -1) {
            ...
            if (id != null) {
                try {
                    ...
                    CadastroClienteDAO cadastroClienteDAO = new CadastroClienteDAO();
                    cadastroClienteDAO.excluir(valorID);
    ...
    private void btnPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarActionPerformed
        try {
            CadastroClienteDAO cadastroClienteDAO = new CadastroClienteDAO();
            List<CadastroCliente> cadastroCliente = cadastroClienteDAO.listar(txtCPF.getText());
    ...
    public void preencherTabela(List<CadastroCliente> cadastroCliente) {
        ...
        for (CadastroCliente c : cadastroCliente) {
            dados[i] = new String[]{
                ...
                c.getCEP(),
                c.getTelefone(),
                c.getClienteDesde() != null ? c.getClienteDesde().format(DateTimeFormatter.ofPattern("dd/MM/yyyy")) : ""
            };
            i++;
        }
