...
import br.com.senac.atividade_06_uc15.persistencia.CadastroVendas;
...
public class TelaControleVendas extends javax.swing.JFrame {
    ...
    public TelaControleVendas() {
        initComponents();
        CadastroDAO controleVendasDAO = new CadastroDAO();
        preencherTabela(controleVendasDAO.listarCPFVenda(txtCPF.getText()));
    ...
    private void btnPesquisarCPFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarCPFActionPerformed
        ...
        try {
            CadastroDAO controleVendasDAO = new CadastroDAO();
            List<CadastroVendas> ListaControleVendas = controleVendasDAO.listarCPFVenda(txtCPF.getText());
    ...
    private void btnPesquisarIDActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarIDActionPerformed
        try {
            CadastroDAO controleVendasDAO = new CadastroDAO();
            List<CadastroVendas> ListaControleVendas = controleVendasDAO.listarIDVenda(txtID.getText());
    ...
    private void btnPesquisarCodActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPesquisarCodActionPerformed
        try {
            CadastroDAO controleVendasDAO = new CadastroDAO();
            List<CadastroVendas> ListaControleVendas = controleVendasDAO.listarCodigoProdutoVenda(txtCod.getText());
    ...
    public void preencherTabela(List<CadastroVendas> controleVendas) {
        ...
        for (CadastroVendas venda : controleVendas) {
            dados[i] = new String[]{
