...
import br.com.senac.atividade_06_uc15.gui.CadastrarFuncionarios;
...
public class ListaCompras {
    ...
    public static void atualizarQtd(int id, int qtd) {
        ...
        CadastroDAO catalogoProdutoDAO = new CadastroDAO();
    ...
    public static void concluirVendaItem() {
        for (Compras c : lista) {
            ...
            CadastroVendas cv = new CadastroVendas();
            cv.setCpfNota(cpf);
            ...
            catalogoProdutoDAO.AtualizarProduto(p);

            CadastroDAO controleVendasDAO = new CadastroDAO();
            controleVendasDAO.CadastrarVenda(cv);
